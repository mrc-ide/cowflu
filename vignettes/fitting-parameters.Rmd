...
```
 The resulting `fitting_samples` item is a list of 5 items. `fittings_samples$pars` is samples from the posterior distribution, which we shall use in the following vignette titled "Plotting model results".
